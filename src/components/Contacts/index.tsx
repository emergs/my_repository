          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Estou disponível para um bate-papo! Vamos conversar?
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text
                  ...
                  onClick={() =>
                    (window.location.href = "mailto:emeregssantos@gmail.com")
                  }
                >
                  Enviar Email
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Podemos criar interações mais constantes pelo Linkedin
                </Text>
                <Text
                  as="a"
                  color="grey2"
